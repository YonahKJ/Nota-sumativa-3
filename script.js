        ...
        datasets: [
            {
                ...
                pointHoverRadius: 8,
                data: [
                    { x: aplicarJitter(1), y: 5120000, name: "DISEÑO GRAFICO MENCION DISEÑO ESTRATEGICO - UNIVERSIDAD DE ANTOFAGASTA" },
                    ...
                    { x: aplicarJitter(1), y: 4305000, name: "DISEÑO - UNIVERSIDAD DE PLAYA ANCHA" },
                    { x: aplicarJitter(1), y: 6552000, name: "DISEÑO EN COMUNICACION VISUAL - USACH" },
                    { x: aplicarJitter(1), y: 4989000, name: "DISEÑO INDUSTRIAL - USACH" },
                    { x: aplicarJitter(1), y: 4307000, name: "DISEÑO GRAFICO - UNIVERSIDAD DEL BIO-BIO" },
                    { x: aplicarJitter(1), y: 4434000, name: "DISEÑO INDUSTRIAL - UNIVERSIDAD DEL BIO-BIO" },
                    { x: aplicarJitter(1), y: 4763300, name: "DISEÑO EN COMUNICACION VISUAL - UTEM" },
                    { x: aplicarJitter(1), y: 4891000, name: "DISEÑO INDUSTRIAL - UTEM" },

                    { x: aplicarJitter(2), y: 8080000, name: "DISEÑO - PONTIFICIA UNIVERSIDAD CATÓLICA DE CHILE" },
                    { x: aplicarJitter(2), y: 6915000, name: "DISEÑO - PONTIFICIA UNIVERSIDAD CATÓLICA DE VALPARAISO" },
                    { x: aplicarJitter(2), y: 9697956, name: "INGENIERIA EN DISEÑO - UNIVERSIDAD ADOLFO IBÁÑEZ" },
                    { x: aplicarJitter(2), y: 7136000, name: "DISEÑO DE JUEGOS DIGITALES - UNIVERSIDAD ANDRÉS BELLO (SANTIAGO)" },
                    { x: aplicarJitter(2), y: 5069000, name: "DISEÑO DE JUEGOS DIGITALES - UNIVERSIDAD ANDRÉS BELLO (CONCEPCION)" },
                    { x: aplicarJitter(2), y: 5069000, name: "DISEÑO DE VESTUARIO Y TEXTIL - UNIVERSIDAD ANDRÉS BELLO" },
                    { x: aplicarJitter(2), y: 7065000, name: "DISEÑO GRAFICO - UNIVERSIDAD ANDRÉS BELLO" },
                    { x: aplicarJitter(2), y: 5887000, name: "DISEÑO - UNIVERSIDAD AUSTRAL DE CHILE" },
                    { x: aplicarJitter(2), y: 5900000, name: "INGENIERIA EN REALIDAD VIRTUAL Y DISEÑO DE JUEGOS DIGITALES - U. BERNARDO O'HIGGINS" },
                    { x: aplicarJitter(2), y: 5276000, name: "DISEÑO - UNIVERSIDAD CATÓLICA DE TEMUCO" },
                    ...
                    { x: aplicarJitter(2), y: 4730000, name: "DISEÑO - UNIVERSIDAD DE LAS AMÉRICAS" },
                    { x: aplicarJitter(2), y: 5887000, name: "DISEÑO - UNIVERSIDAD DE TALCA" },
                    { x: aplicarJitter(2), y: 6555000, name: "DISEÑO MULTIMEDIA - UNIVERSIDAD DE TARAPACÁ" },
                    { x: aplicarJitter(2), y: 5713000, name: "DISEÑO - UNIVERSIDAD DE VALPARAÍSO" },
                    { x: aplicarJitter(2), y: 4277000, name: "DISEÑO - UNIVERSIDAD DE VIÑA DEL MAR" },
                    { x: aplicarJitter(2), y: 10334175, name: "BACHILLERATO EN DISEÑO - UNIVERSIDAD DEL DESARROLLO (SANTIAGO)" },
                    { x: aplicarJitter(2), y: 9726283, name: "DISEÑO - UNIVERSIDAD DEL DESARROLLO (SANTIAGO)" },
                    { x: aplicarJitter(2), y: 6038400, name: "DISEÑO - UNIVERSIDAD DEL DESARROLLO (CONCEPCION)" },
                    { x: aplicarJitter(2), y: 7597000, name: "DISEÑO - UNIVERSIDAD DIEGO PORTALES" },
                    { x: aplicarJitter(2), y: 7200000, name: "BACHILLERATO EN ARTES, ARQUITECTURA Y DISEÑO - UNIVERSIDAD FINIS TERRAE" },
                    { x: aplicarJitter(2), y: 7320000, name: "DISEÑO - UNIVERSIDAD FINIS TERRAE" },
                    ...
                    { x: aplicarJitter(2), y: 6000000, name: "INGENIERIA EN DISEÑO DE PRODUCTOS - UTFSM (VALPARAÍSO)" },
                    { x: aplicarJitter(2), y: 6000000, name: "INGENIERIA EN DISEÑO DE PRODUCTOS - UTFSM (SANTIAGO)" },
                    { x: aplicarJitter(2), y: 5180000, name: "INGENIERIA EN FABRICACION Y DISEÑO INDUSTRIAL - UTFSM" }
                ]
            },
            {
                ...
                pointHoverRadius: 8,
                data: [
                    { x: aplicarJitter(2), y: 4210000, name: "DISEÑO DE INTERIORES Y AMBIENTES - UNIACC" },
                    { x: aplicarJitter(2), y: 4030000, name: "DISEÑO DE JUEGOS DIGITALES - UNIACC" }
                ]
            }
        ]
    },
